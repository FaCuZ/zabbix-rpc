...
*/
UserMacro.prototype.get = (params = []) => {
...
*/
UserMacro.prototype.create = (params, isGlobal = false) => {
...
*/
UserMacro.prototype.delete = (params, isGlobal = false) => {
	let global_str = (isGlobal) ? 'global' : ''
...
*/
UserMacro.prototype.update = (params, isGlobal = false) => {
	let global_str = (isGlobal) ? 'global' : ''
